...
@PerFragment
public class AppsItemAdapter extends RecyclerView.Adapter<AppsViewHolder> {
    ...
    @Inject
    public AppsItemAdapter(AppListaMvvm.ViewModel viewModel, ClienteListarObservableModel model) {
    ...
    @Override
    public AppsViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View itemView = LayoutInflater.
                from(viewGroup.getContext()).
                inflate(R.layout.item_app, viewGroup, false);
        return new AppsViewHolder(itemView,viewModel);
    }

    @Override
    public void onBindViewHolder(AppsViewHolder viewHolder, int position) {

...
public abstract class BaseViewHolderViewModel<V extends MvvmView> extends BaseAppViewModel<V> implements IViewModel<V> {

    protected final Context con;
    protected final Navigator navigator;

    public BaseViewHolderViewModel(@AppContext Context context, Navigator navigator) {
